...
public class DateTimeUtils {
    ...
    public static String getTimespan(Date startDate, Date endDate) {
        Duration duration = Duration.between(startDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime(),
