...
<head>
  ...
  <title>Error!</title>
  <script type="text/javascript" src="<@s.url '/vendor/jquery/jquery-3.3.1.slim.min.js'/>"></script>
...
<section class="text-center pt-5">
  ...
  <h1 style="color: #ff024d;" class="h1">${errorCodeMessage???then(errorCodeMessage, "")}</h1>
  <h1 class="h2">${message???then(message, "")}</h1>
  <p class="h2">If it's our mistakes, we are going to fix it soon. ´༎ຶ ͜ʖ ༎ຶ `</p>
  <p class="h2">Hope you will ignore our mistakes ( 灬♥ ͜ʖ ♥灬)</p>
