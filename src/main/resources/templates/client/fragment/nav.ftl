  ...
  <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
    ...
    <div class="collapse navbar-collapse" id="menu-bar">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link <#if link == "core-java">active</#if>" href="/java">Java</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <#if link == "core-java">active</#if>" href="/core-java">Servlet/JSP</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link <#if link == "angular-js" || link == "angular-cli">active</#if> dropdown-toggle" href="#"
             id="angular-dropdown" data-toggle="dropdown" aria-haspopup="true"
