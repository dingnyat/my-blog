  ...
  <script>
      ...
      $(function () {
          ...
          $("#link-series-category-modal form").submit(function (e) {
              ...
              $.ajax({
                  ...
                  contentType: "application/json",
                  headers: {'X-CSRF-TOKEN': csrf_token},
                  data: JSON.stringify({seriesId: seriesId, categoryId: selectedId}),
                  success: function () {
      ...
      function deselectSeries(seriesId, categoryId) {
          $.ajax({
              ...
              contentType: "application/json",
              headers: {'X-CSRF-TOKEN': csrf_token},
              data: JSON.stringify({seriesId: seriesId, categoryId: categoryId}),
              success: function () {
          ...
          <form method="post" action="${'/admin/category/add'}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <textarea class="form-control" name="description" id="input-description" rows="10"></textarea>
                </div>
              </div>
            </div>
...
<@displayPage page_title="Quản Lý Danh Mục"/>
