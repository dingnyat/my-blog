                  ...
                  },
                  {
                      render: function (data, type, row) {
                          return '<a data-toggle="tooltip" title="Xem bài viết" href="/post/' + row.code + '" class="btn btn-sm btn-success ml-1"><i class="fas fa-arrow-right"></i></a>'
                              ...
                              + '<button title="Xóa bài viết" data-toggle="modal" data-target="#delete-confirm-dialog" data-json="' + encodeURI(JSON.stringify(row)) + '" class="btn btn-sm btn-danger ml-1"><i class="fas fa-trash"></i></button>';
                      },
                      targets: 5
                  }
              ],
...
<@displayPage page_title="Quản Lý Bài Viết"/>
